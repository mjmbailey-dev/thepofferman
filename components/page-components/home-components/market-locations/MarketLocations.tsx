...
export default function MarketLocations(){
    return(
        <section className="w-full bg-primary-dark h-auto flex justify-center py-10 md:py-15">
            <div className="max-w-7xl mx-10 mt-10 w-full">
                <h2 className="header-style text-neutral-lightest text-center">Find Us?</h2>
