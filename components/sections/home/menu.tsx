...
export default function Menu(){
    return(
        <section className="w-full bg-background-3 flex justify-center border-b-5 border-primary">
                ...
                <div className="flex flex-col align-middle text-center items-center my-10 gap-20 w-full">
                    ...
                    <div className="flex flex-row gap-20 justify-evenly">
                        <div className="flex flex-col align-top items-center text-center">
                            <Dot size={50} className="text-primary" strokeWidth={11}/>
                            <h4>Regular</h4>
                            <p>$8.50</p>
                        </div>
                        <div className="flex flex-col align-top items-center text-center">
                    ...
                    lg:gap-x-50">
                            <div className="flex flex-col align-middle justify-start items-center text-center gap-y-5">
                                <div className="h-30 md:h-40 flex justify-center items-end ">
                                    <ButterIcon className="text-primary w-30 h-auto md:w-40"/>
                                </div>
                                <h4>Traditional</h4>
                            ...
                            <div className="flex flex-col align-middle justify-start items-center text-center gap-y-5">
                                <WhippedCreamIcon className="text-primary w-30 h-30 md:w-40 md:h-40"/>
                                <h4>Whipped Cream</h4>
                                <p>+50c</p>
                            </div>

                            <div className="flex flex-col align-middle justify-start items-center text-center gap-y-5">
                                <NutellaIcon strokeWidth={0} className="text-primary w-30 h-30 md:w-40 md:h-40"/>
                                <h4>Nutella</h4>
                                <p>+$2.50</p>
                            </div>
                            ...
                            <div className="flex flex-col align-middle justify-start items-center text-center gap-y-5">
                                <MapleSyrupIcon strokeWidth={0} className="text-primary w-30 h-30 md:w-40 md:h-40"/>
                                <h4 >Maple Syrup</h4>
                                <p>+$1.50</p>
                            </div>

                            <div className="flex flex-col align-middle justify-start items-center text-center gap-y-5">
                                <BiscoffIcon strokeWidth={0} className="text-primary w-30 h-30 md:w-40 md:h-40"/>
                                <h4 >Biscoff</h4>
                                <p>+$2.50</p>
                            </div>

                            <div className="flex flex-col align-middle justify-start items-center text-center gap-y-5">
                                <CitrusIcon size={100} strokeWidth={1} className="text-primary w-30 h-30 md:w-40 md:h-40"/>
                                <h4>Lemon</h4>
                                <p>+50c</p>
                            </div>
                    </div>
